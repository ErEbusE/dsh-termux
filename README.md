...
The quickest way, on any install type:
...
dsh moves fast. Under the hood, updating means running `update-dsh.sh`, e.g. to the npm `next` tag with every prompt auto-accepted:
